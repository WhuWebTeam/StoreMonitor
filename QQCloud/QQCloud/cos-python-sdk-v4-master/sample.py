...
def cos_demo():
    ...
    appid = 1254257254               # 替换为用户的appid
    secret_id = u'AKIDaz94pRjzwd5HDthVQ5UeYBYfWAZjEPsB'         # 替换为用户的secret_id
    secret_key = u'C8oEPKzPbYGivsZ1ECyXrwmNjspXzC9q'         # 替换为用户的secret_key
    region = "guangzhou" #           # 替换为用户的region，目前可以为 shanghai/guangzhou
